...
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','ConfigManage','構成管理','inner:${menuPrefixPath}/h-dbc/Config','-',1,1,'Console',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Profile','環境管理','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/profile','ConfigManage',0,2,'profile2',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Service','サービス管理','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/service','ConfigManage',1,2,'service3',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Backup','構成の回復','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/back/data','ConfigManage',2,2,'recovery5',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Encrypt','暗号化および復号化ツール','inner:${menuPrefixPath}/h-dbc/hbq969-common/index.html#/encrypt','ConfigManage',3,2,'encrypt2',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Guide','ガイドドキュメント','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/guide','ConfigManage',-1,2,'guide',1735800456);
...
INSERT INTO h_tabula (table_name, table_desc, creator, manage_enabled, create_time, update_time, source_dialect, source_schema) VALUES ('log_dbc', '構成センター操作ログ', 'admin', 0, 1743584250, 0, '${defaultDataBaseSource}', '${defaultDataBaseSchema}');
