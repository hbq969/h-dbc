...
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Encrypt','加解密工具','inner:/h-dbc/hbq969-common/index.html#/encrypt','Config',2,2,'encrypt4',1735800456);
