...
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Backup','配置恢复','inner:/h-dbc/dbc-ui/index.html#/back/data','Config',2,2,'recovery2',1735800456);
