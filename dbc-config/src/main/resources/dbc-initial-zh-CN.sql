...
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Config','配置管理','inner:${menuPrefixPath}/h-dbc/Config','-',1,1,'Console',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Profile','环境管理','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/profile','Config',0,2,'profile2',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Service','服务管理','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/service','Config',1,2,'service3',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Backup','配置恢复','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/back/data','Config',2,2,'recovery5',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Encrypt','加解密工具','inner:${menuPrefixPath}/h-dbc/hbq969-common/index.html#/encrypt','Config',3,2,'encrypt2',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Guide','引导文档','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/guide','Config',-1,2,'guide',1735800456);
