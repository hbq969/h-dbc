...
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','ConfigManage','配置管理','inner:${menuPrefixPath}/h-dbc/Config','-',1,1,'Console',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Profile','环境管理','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/profile','ConfigManage',0,2,'profile2',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Service','服务管理','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/service','ConfigManage',1,2,'service3',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Backup','配置恢复','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/back/data','ConfigManage',2,2,'recovery5',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Encrypt','加解密工具','inner:${menuPrefixPath}/h-dbc/hbq969-common/index.html#/encrypt','ConfigManage',3,2,'encrypt2',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','Guide','引导文档','inner:${menuPrefixPath}/h-dbc/dbc-ui/index.html#/guide','ConfigManage',-1,2,'guide',1735800456);
insert into h_menus(app,name,menu_desc,url,parent_key,order_index,menu_level,icon_name,created_at) values('h-dbc','OperLog','操作日志','inner:${menuPrefixPath}/h-dbc/hbq969-tabula/index.html#/data?report=true&source=${defaultDataBaseSource}%2C${defaultDataBaseSchema}&dialect=${defaultDataBaseSource}&schema=${defaultDataBaseSchema}&name=log_dbc&desc=%E9%85%8D%E7%BD%AE%E4%B8%AD%E5%BF%83%E6%93%8D%E4%BD%9C%E6%97%A5%E5%BF%97&manage=0&fmtManage=%E5%90%A6&create=null&creator=admin&createTime=1743584250','ConfigManage',6,2,'TableManagementIcon',1735800456);
...
INSERT INTO h_tabula (table_name, table_desc, creator, manage_enabled, create_time, update_time, source_dialect, source_schema) VALUES ('log_dbc', '配置中心操作日志', 'admin', 0, 1743584250, 0, '${defaultDataBaseSource}', '${defaultDataBaseSchema}');
